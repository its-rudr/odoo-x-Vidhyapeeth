                  ...
                  <tr key={v._id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    {(canEdit || canDelete) && <td className="px-5 py-3.5">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {canEdit && <button onClick={() => handleToggleOOS(v)} className="p-1.5 rounded-lg transition-colors text-xs font-medium" style={{ color: '#DD700B' }} title="Toggle Out of Service">{v.status === 'Out of Service' ? 'Activate' : 'Retire'}</button>}
